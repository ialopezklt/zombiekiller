...
//		labArmas[3].setVisible(false);
	...
	public void inicializarAtributos () {
		...
		valores[0] = remington.getDanio();
		valores[1] = remington.getRetroceso();
		valores[2] = remington.getTiempoCarga();
		...
		Weapon m1911 = WeaponFactory.getWeapon("M1911");
		valores[0] = m1911.getDanio();
		valores[1] = m1911.getRetroceso();
		valores[2] = m1911.getTiempoCarga();
